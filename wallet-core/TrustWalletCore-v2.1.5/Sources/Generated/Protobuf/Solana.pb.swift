...
public struct TW_Solana_Proto_SigningInput {
  ...
  /// recent blockhash/durable transaction nonce
...
extension TW_Solana_Proto_SigningInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    12: .standard(proto: "create_nonce_account"),
    13: .standard(proto: "withdraw_nonce_account"),
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .withdrawNonceAccount?: try {
      guard case .withdrawNonceAccount(let v)? = self.transactionType else { preconditionFailure() }
