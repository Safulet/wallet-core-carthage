...
public final class Account {
    ...
    public init(address: String, coin: CoinType, derivationPath: String, publicKey: String, extendedPublicKey: String) {
        ...
        rawValue = TWAccountCreate(addressString, TWCoinType(rawValue: coin.rawValue), derivationPathString, publicKeyString, extendedPublicKeyString)
    }
