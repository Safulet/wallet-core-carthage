...
/// Amount
public struct TW_CosmosOld_Proto_Amount {
...
/// Fee
public struct TW_CosmosOld_Proto_Fee {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var amounts: [TW_CosmosOld_Proto_Amount] = []
...
public struct TW_CosmosOld_Proto_SendCoinsMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Message for staking.
public struct TW_CosmosOld_Proto_StakeMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var amount: TW_CosmosOld_Proto_Amount {
    get {return _storage._amount ?? TW_CosmosOld_Proto_Amount()}
...
public struct TW_CosmosOld_Proto_ReStakeMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Message for staking.
public struct TW_CosmosOld_Proto_WithdrawStakeRewardMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Signature
public struct TW_CosmosOld_Proto_Signature {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Transaction
public struct TW_CosmosOld_Proto_Transaction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var fee: TW_CosmosOld_Proto_Fee {
    get {return _storage._fee ?? TW_CosmosOld_Proto_Fee()}
  ...
  public var signature: TW_CosmosOld_Proto_Signature {
    get {return _storage._signature ?? TW_CosmosOld_Proto_Signature()}
  ...
  public var sendCoinsMessage: TW_CosmosOld_Proto_SendCoinsMessage {
    get {
      if case .sendCoinsMessage(let v)? = _storage._messageOneof {return v}
      return TW_CosmosOld_Proto_SendCoinsMessage()
    }
    set {_uniqueStorage()._messageOneof = .sendCoinsMessage(newValue)}
  }

  public var stakeMessage: TW_CosmosOld_Proto_StakeMessage {
    get {
      if case .stakeMessage(let v)? = _storage._messageOneof {return v}
      return TW_CosmosOld_Proto_StakeMessage()
    }
    set {_uniqueStorage()._messageOneof = .stakeMessage(newValue)}
  }

  public var unstakeMessage: TW_CosmosOld_Proto_StakeMessage {
    get {
  ...
  public var restakeMessage: TW_CosmosOld_Proto_ReStakeMessage {
    get {
      if case .restakeMessage(let v)? = _storage._messageOneof {return v}
      return TW_CosmosOld_Proto_ReStakeMessage()
    }
    set {_uniqueStorage()._messageOneof = .restakeMessage(newValue)}
  }

  public var withdrawStakeRewardMessage: TW_CosmosOld_Proto_WithdrawStakeRewardMessage {
    get {
      if case .withdrawStakeRewardMessage(let v)? = _storage._messageOneof {return v}
      return TW_CosmosOld_Proto_WithdrawStakeRewardMessage()
    }
  ...
  public enum OneOf_MessageOneof: Equatable {
    case sendCoinsMessage(TW_CosmosOld_Proto_SendCoinsMessage)
    case stakeMessage(TW_CosmosOld_Proto_StakeMessage)
    case unstakeMessage(TW_CosmosOld_Proto_StakeMessage)
    case restakeMessage(TW_CosmosOld_Proto_ReStakeMessage)
    case withdrawStakeRewardMessage(TW_CosmosOld_Proto_WithdrawStakeRewardMessage)

  #if !swift(>=4.1)
    public static func ==(lhs: TW_CosmosOld_Proto_Transaction.OneOf_MessageOneof, rhs: TW_CosmosOld_Proto_Transaction.OneOf_MessageOneof) -> Bool {
      switch (lhs, rhs) {
...
public struct TW_CosmosOld_Proto_SigningInput {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: TW_CosmosOld_Proto_SigningInput.OneOf_MessageOneof, rhs: TW_CosmosOld_Proto_SigningInput.OneOf_MessageOneof) -> Bool {
      switch (lhs, rhs) {
      case (.sendCoinsMessage(let l), .sendCoinsMessage(let r)): return l == r
      case (.stakeMessage(let l), .stakeMessage(let r)): return l == r
      case (.unstakeMessage(let l), .unstakeMessage(let r)): return l == r
...
public struct TW_CosmosOld_Proto_SigningOutput {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "TW.Cosmos_old.Proto"

extension TW_CosmosOld_Proto_Amount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: TW_CosmosOld_Proto_Amount, rhs: TW_CosmosOld_Proto_Amount) -> Bool {
...
extension TW_CosmosOld_Proto_Fee: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: TW_CosmosOld_Proto_Fee, rhs: TW_CosmosOld_Proto_Fee) -> Bool {
...
extension TW_CosmosOld_Proto_SendCoinsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: TW_CosmosOld_Proto_SendCoinsMessage, rhs: TW_CosmosOld_Proto_SendCoinsMessage) -> Bool {
...
extension TW_CosmosOld_Proto_StakeMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _amount: TW_CosmosOld_Proto_Amount? = nil
  ...
  public static func ==(lhs: TW_CosmosOld_Proto_StakeMessage, rhs: TW_CosmosOld_Proto_StakeMessage) -> Bool {
...
extension TW_CosmosOld_Proto_ReStakeMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: TW_CosmosOld_Proto_ReStakeMessage, rhs: TW_CosmosOld_Proto_ReStakeMessage) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension TW_CosmosOld_Proto_WithdrawStakeRewardMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: TW_CosmosOld_Proto_WithdrawStakeRewardMessage, rhs: TW_CosmosOld_Proto_WithdrawStakeRewardMessage) -> Bool {
...
extension TW_CosmosOld_Proto_Signature: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: TW_CosmosOld_Proto_Signature, rhs: TW_CosmosOld_Proto_Signature) -> Bool {
...
extension TW_CosmosOld_Proto_Transaction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _fee: TW_CosmosOld_Proto_Fee? = nil
    var _memo: String = String()
    var _signature: TW_CosmosOld_Proto_Signature? = nil
    var _messageOneof: TW_CosmosOld_Proto_Transaction.OneOf_MessageOneof?
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4:
          var v: TW_CosmosOld_Proto_SendCoinsMessage?
        ...
        case 5:
          var v: TW_CosmosOld_Proto_StakeMessage?
          if let current = _storage._messageOneof {
            try decoder.handleConflictingOneOf()
        ...
        case 7:
          var v: TW_CosmosOld_Proto_ReStakeMessage?
          if let current = _storage._messageOneof {
            try decoder.handleConflictingOneOf()
        ...
        case 8:
          var v: TW_CosmosOld_Proto_WithdrawStakeRewardMessage?
          if let current = _storage._messageOneof {
            try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: TW_CosmosOld_Proto_Transaction, rhs: TW_CosmosOld_Proto_Transaction) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension TW_CosmosOld_Proto_SigningInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _messageOneof: TW_CosmosOld_Proto_SigningInput.OneOf_MessageOneof?
    var _typePrefix: String = String()
  ...
  public static func ==(lhs: TW_CosmosOld_Proto_SigningInput, rhs: TW_CosmosOld_Proto_SigningInput) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension TW_CosmosOld_Proto_SigningOutput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: TW_CosmosOld_Proto_SigningOutput, rhs: TW_CosmosOld_Proto_SigningOutput) -> Bool {
    if lhs.signature != rhs.signature {return false}
